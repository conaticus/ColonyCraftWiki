...
You can click one to make it your Skill Focus! To check what skills you have at any time, use the `/skills` command. If you are in a colony, you can also use `/skills <playername>` to check the skills of another player in your colony.

:::warning Warning
You can use the `/skill_focus` command again if you wish to choose a different skill focus, **this will reset all progress for your current skill focus**. You can only focus on one skill at a time.
:::
