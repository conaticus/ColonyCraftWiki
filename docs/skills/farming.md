...
**Growth Rates** \
By default crops placed inside a claim grow 2x slower than usual rates in Minecraft. This is increased to the usual rate when reaching Farming Level 1. When you are offline, crops grow 4x slower, no matter what level the player is.
...
You can assign animals to your claim, which can be grown by using animal feeders. The more an animal has grown, the more meat and other materials will be dropped when it is killed. Note that each claim can have a **maximum of 50 animals**.
...
At Level 2 you can also harvest honey from bees nests which can be an excellent food source for players. At Level 4 you can craft bee hives to place directly in front of your farms (to pollenate crops faster).
...
- +25% Faster Cooking
- 15% Max Animal Growth
- 20 Crops per Claim

**Level 2**
- +30% Faster Cooking
- 30% Max Animal Growth
- Can Harvest Honey
- 40 Crops per Claim

**Level 3**
- +30% Faster Cooking
- 45% Max Animal Growth
- 70 Crops per Claim

**Level 4**
- +30% Faster Cooking
- 60% Max Animal Growth
- Craft and Use Bee Hive
- Craft and Use Smoker
- 100 Crops per Claim
...
|               Harvest                | XP Amount |
| :----------------------------------: | :-------: |
|       Honey, Wheat, Carrots, Potatoes       |    25     |
| Melon, Pumpkin, Cocoa, Sweet Berries |    8     |

You can also gain XP from the following:

- Cooking Food in a Furnace: **1XP per Cooked Food**
- Growing Animals: **20XP per 20% Growth**
