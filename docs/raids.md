...
It is also worth noting that you can raid people's bases even if they are in the same colony as you! Some bases can be manually set to 

### Offline Claim Owners
Most bases will only be raidable if the claim owner is online. In which case, you'll need to wait for them to log onto the server to break in. In some cases claim owners may turn on the [Raidable Offline](/docs/claims/protecting_items.md) setting which increases risk of raids however makes their ownership of that claim completely anonymous (raiders cannot deduce who owns the claim based on who is online).

### Raiding a Base

All containers (except shop chests) can be opened by any player, no matter if land is claimed or not (see [Protecting your Items](/docs/claims/protecting_items.md#protecting-your-items)). Once you find a container, such as a chest, you can open it and steal the items inside it!
...
3. Repeatedly destroy the block, and wait for the progress bar to complete

Example:
<img src="/img/raids.gif" />

### Raiding Shop Chests
A slightly different method is required to raid a shop chest. You must break it using a **Powerful Raid Pickaxe** (other raid pickaxes will not work) to drop the stock entered by the seller and profits earned from buyers.

If it is a double chest, to collect both the profits and the stock, ensure that you destroy both sides of the shop chest:

<img src="/img/shop_raid.gif" />
...
|         **Tool**          |        **Block**        | **Break Cyles to Destroy** |
| :-----------------------: | :---------------------: | :-------------------: |
